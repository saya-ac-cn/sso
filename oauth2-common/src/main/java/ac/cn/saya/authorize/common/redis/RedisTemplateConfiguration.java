package ac.cn.saya.authorize.common.redis;

import ac.cn.saya.authorize.common.util.JsonUtils;
...
public class RedisTemplateConfiguration {
    ...
    private RedisSerializer<Object> valueSerializer() {
        ...
        serializeConfig.put(LocalDateTime.class, (serializer, object, fieldName, fieldType, features) -> {
            ...
            out.writeString(DateTimeFormatter.ofPattern(JsonUtils.DEFAULT_DATE_TIME_PATTERN).format((LocalDateTime) object));
        });
        ...
        serializeConfig.put(LocalDate.class, (serializer, object, fieldName, fieldType, features) -> {
            ...
            out.writeString(DateTimeFormatter.ofPattern(JsonUtils.DEFAULT_DATE_PATTERN).format((LocalDate) object));
        });
        ...
        serializeConfig.put(LocalTime.class, (serializer, object, fieldName, fieldType, features) -> {
            ...
            out.writeString(DateTimeFormatter.ofPattern(JsonUtils.DEFAULT_TIME_PATTERN).format((LocalTime) object));
        });
        ...
        serializeConfig.put(Date.class, (serializer, object, fieldName, fieldType, features) -> {
            ...
            out.writeString(DateFormatUtils.format((Date) object, JsonUtils.DEFAULT_DATE_TIME_PATTERN));
        });
