package ac.cn.saya.authorize.server.config;

import ac.cn.saya.authorize.server.interceptor.OAuth2ServerInterceptor;
...
import static ac.cn.saya.authorize.common.util.JsonUtils.*;
